...
landuse <- raster('C:/Users/Paul Coderre/Documents/Thesis/HYPE/HYPE_geospatial/separated_geospacial/landsat/milk_landsat_repro.tif')
#read the soil texture raster
soiltex <- raster('C:/Users/Paul Coderre/Documents/Thesis/HYPE/HYPE_geospatial/separated_geospacial/soil/milk_soilsoil_classes.tif')
...
# catchments polygon
cat_poly <- read_sf('C:/Users/Paul Coderre/Documents/Thesis/HYPE/HYPE_geospatial/milk_shapefile/Milk_Shapefile.shp')
...
write.csv(x = slc_frac, file = 'milk_landsat_slc.csv', quote = F)
